<x-layout>
  <button class="bg-laravel text-white rounded py-2 px-2 hover:bg-white mb-6 ml-5">
    <a href="/logang" class="hover:text-laravel"><i class="fa-solid fa-arrow-left"></i> Back </a>
  </button>
  <div class="mx-4">
    <x-card class="p-10">
      <div class="flex flex-col items-center justify-center text-center">
        ...
        <div>
          ...
          <div class="text-lg space-y-6">
            ...
            <a href="mailto:{{$listingmagang->Email}}" class="block bg-laravel text-white mt-6 py-2 rounded-xl hover:opacity-80">
              <i class="fa-solid fa-envelope"></i>
              Contact Employer
            </a>

            <a href="{{$listingmagang->Website}}" target="_blank" class="block bg-black text-white py-2 rounded-xl hover:opacity-80">
